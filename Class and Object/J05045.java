...
class NhanVien2 implements Comparable<NhanVien2>{
    ...
    public NhanVien2(String hoTen, String chucVu, int luongCoBan, int soNgayCong) {
...
public class J05045 {
    public static void main(String[] args) {
        ...
        while(n-- > 0){
            ...
            list.add(new NhanVien2(hoTen, chucVu, luongCoBan, soNgayCong));
        }
        Collections.sort(list);
        for(NhanVien2 x : list){
